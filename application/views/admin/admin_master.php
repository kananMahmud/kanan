    ...
    <body class="page-body page-fade">
        ...
        <div class="page-container">	
                ...
                <ul id="main-menu" class="">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>super_admin/manage_category"><i class="fa fa-file-text"></i><span>Manage Category</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>super_admin/add_blog"><i class="fa fa-file-text"></i><span>Add Blog</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>super_admin/manage_blog"><i class="fa fa-file-text"></i><span>Manage Blog</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="main-content">
                ...
                <!-- Footer -->
                <footer class="main">
                    &copy; 2014 <strong>kanan mahmud</strong> Admin Theme by <a href="" target="_blank">kananmahmud.com/me</a>
                </footer>	
            </div>
